...
namespace Ryggsäcken_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] saker = new string[5]; // Skapar en tom stringvektor med 5 element som skall skrivas till i senare skede
            ...
            while (meny) // skapar en while loop som fortsätter så länge meny är sant, behövs för att menyn ska fungera som tänkt
            {

                Console.WriteLine("\n[1] Lägg till 5 föremål"); // Texten frågar användaren om den vill lägga till föremål 
                ...
                try
                {
                    switch (num) // skapar en switch som tittar efter värdet i num variabeln för att veta vilket case som ska bli aktivt, switch passade i detta fallet.
                    {
                        ...
                        case 3: // gör det möjligt att söka på enstaka saker i variabeln                         
                            ...
                            foreach (string sak in saker) // loopar så länge det finns något sparat i variabeln saker 
                            {
                                if (sak.ToLower() == sparadSak.ToLower()) // jämför de saparde värdena i vektorn saker med värdet i sparadSak, allt med små bokstäver oavsett hur man skrivit
                                {
                        ...
                        case 5: // sätter bool variabeln till false och avslutar loopen
                            meny = false;
                            break;
                        default: // skriver ut ogiltigt val om användaren inte väljer 1-5
